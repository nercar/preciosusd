        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-xs-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Status diario por Sucursal</h3>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Status General por dia</h3>
                <?php
                  /*if(@$_POST[crear])
                   {
            ...
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Ciclo de Servicio por Dia</h3>
                <?php
                  $data11 = '';
                  $vector3 = array();
                  ...
                  $resul11=$activo5->Total_Ciclo_Servicio_Dia();
                  if($resul11)
                   {
                    $con11=0;
                    while($row11 = mysqli_fetch_array($resul11))
                     {
                      $valor5[$con11] = $row11[0];
                      $valor6[$con11] = $row11[1];
                      $valor7[$con11] = $row11[2];
                      $var5 = $row11[0];

                      $vector3[$var5]=$valor7[$con11];
                      //echo '<BR>'.$var5." -- ".$vector3[$var5]." = ".$valor7[$con11];
                      $con11++;
                     }
                   }
              ...
              <div class="card-body">
                ...
                <script>
                 ...
                 type: 'doughnut',
                 data: {
                        labels: ["SAIG", "Balanzas", "Linea Caja", "Pto Venta", "RedCom", "Eq. Operativos", "Eq. Administrativos", "Fotocopidoras", "CCTV"],
                        datasets: [{
                                    data: [<?php echo $data11; ?>],
                                    //backgroundColor: ["#F7464A", "#46BFBD", "#FDB45C", "#949FB1", "#4D5360"],
                                    //hoverBackgroundColor: ["#FF5A5E", "#5AD3D1", "#FFC870", "#A8B3C5", "#616774"]
                                    backgroundColor: ["#ff6384", "#44e4ee","#949FB1","#3366FF","#FDB45C","#F7464A", "#46BFBD","#4D5360","#FFFF33"],
                                    hoverBackgroundColor: ["#ff6384", "#44e4ee","#949FB1","#3366FF","#FDB45C","#F7464A", "#46BFBD","#4D5360","#FFFF33"]
                                  }]
                       },
                 options: {
                           responsive: true
          ...
          <div class="col-md-6">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Status Mensual por Sucursal</h3>
                <?php
                  $data7 = '';
                  $data8 = '';
                  $data9 = '';
                  ...
                  //echo "El valor del Status es ".$con9;
                  $resul5=$activo5->Totales_Status_Mes();
                  if($resul5)
                   {
                    $con5=0;
                    while($row5 = mysqli_fetch_array($resul5))
                     {
                      $rst_mes[$con5] = $row5[0];
                      $rst_id[$con5] = $row5[1];
                      $rst_cantidad[$con5] = $row5[2];
                      $var3 = $row5[0];
                      $var4 = $row5[1];
                      
                      $matriz2[$var3][$var4]=$rst_cantidad[$con5];
                      //echo '<BR>'.$var3." ".$var4." --> ".$matriz2[$var3][$var4]." = ".$rst_cantidad[$con5];
                      $con5++;
                     }
                   }
                  ...
                  for($i=1;$i<=12;$i++)
                   {
                    $data7 = $data7 . '"'. $matriz2[$i][1].'",';
                    $data8 = $data8 . '"'. $matriz2[$i][2].'",';
                    $data9 = $data9 . '"'. $matriz2[$i][3].'",';
                    $data10 = $data10 . '"'. $matriz2[$i][4].'",';
                   }
                ?>
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Fallas Diarias por Sucursal</h3>
                <?php
                  $data10 = '';
                  $data20 = '';
                  $var10=0;
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12 col-xs-12">
              <div class="card card-secondary">
                <div class="card-header">
                  <h3 class="card-title">Sucursales - Areas</h3>
                </div>
