...
<head>
  ...
  <title>Ciclo de Servicios | PUNTOS DE VENTA</title>
       ...
       echo "<div class='col-md-6'>";
        echo "<div class='card'>";
         echo "<div class='card-header'>";
          echo "<h5 class='text-primary'> Puntos de Venta / Sucursal: $def_sucursal[$con1] / Caja Número: $flag2 </h5>";
         echo "</div>";
  ...
  if(@$_POST[guardar])
   {
    ...
    if($flag=='1' && $flag2=='1') 
     {
      echo "<script> alert('Punto(s) de venta registrados exitosamente en Caja $puesto'); </script>";
     }
