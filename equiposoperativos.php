...
<head>
  ...
  <title>Ciclo de Servicios | EQUIPOS OPERATIVOS</title>
            ...
            <div class="offset-md-2 col-md-8 offset-md-2">
                <div class="card">
                    <div class="card-header bg-info text-white">
                        <h4 class="card-title text-uppercase">EQUIPOS OPERATIVOS</h4>
                    </div>
                    <div class="card-body">
...
<?php
  ...
  $Vector_Datos = array();
  echo '<BR>';
  echo "<h5 class='text-primary'>Equipos Operativos:</h5>";
  echo '<BR>';
  //echo '<BR>';
  //echo '<BR>'." Paso: ".$paso;
    for($i=0;$i<$filas;$i++)
          ...
          while($row3=mysqli_fetch_array($resul3))
           {
            ...
            if($i==$con3)
             {
              echo "<label for='equiposoperativos'>$xyz_descripcion[$i]:</label>";
