            ...
            <div class="card">
              ...
              <div class="card-body text-center">
                <div class="sparkline" data-type="line" data-spot-Radius="3" data-highlight-Spot-Color="#f39c12"
                  ...
                  36,34,27,28,14,23,12,23,55,62,57,44,21,15,37,49,39,58,27,56
                </div>
              </div>
              <!-- /.card-body -->
            </div>
            ...
            <div class="card">
              ...
              <div class="card-body text-center">
                <div class="sparkline" data-type="bar" data-width="97%" data-height="100px" data-bar-Width="14"
                     data-bar-Spacing="7" data-bar-Color="#f39c12"><?php echo $valor1;?>,<?php echo $valor2;?>,<?php echo $valor3;?>
                </div>
              </div><!-- /.card-body -->
            </div><!-- /.card -->
          </div><!-- /.col -->
              ...
              <div id="myBody" class="card-body">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <p>
                      Bar charts <span class="sparkbar">9,11,10,8,10,11,10,8,9,8,10</span>
                      negative values: <span class="sparkbar">-5,1,2,0,-3,-4</span>
